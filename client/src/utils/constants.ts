...
export const QUESTION_COUNT_PRESETS = [3, 5, 8, 10];
...
export const AVAILABLE_QUESTIONS_MAP: Record<GameLevel, Record<GameType, number>> = {
  A1: { SCHNELLANTWORT: 10, SATZ_RENNEN: 6, WORTSCHATZ_DUELL: 6, WAS_BIN_ICH: 4, TEAM_BATTLE: 5 },
  A2: { SCHNELLANTWORT: 8, SATZ_RENNEN: 5, WORTSCHATZ_DUELL: 5, WAS_BIN_ICH: 4, TEAM_BATTLE: 5 },
  B1: { SCHNELLANTWORT: 8, SATZ_RENNEN: 5, WORTSCHATZ_DUELL: 5, WAS_BIN_ICH: 4, TEAM_BATTLE: 5 },
  B2: { SCHNELLANTWORT: 8, SATZ_RENNEN: 5, WORTSCHATZ_DUELL: 5, WAS_BIN_ICH: 4, TEAM_BATTLE: 5 },
};
