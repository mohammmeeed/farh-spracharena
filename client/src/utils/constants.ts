...
export const AVAILABLE_QUESTIONS_MAP: Record<GameLevel, Record<GameType, number>> = {
  A1: { SCHNELLANTWORT: 20, SATZ_RENNEN: 15, WORTSCHATZ_DUELL: 20, WAS_BIN_ICH: 15, TEAM_BATTLE: 15 },
  A2: { SCHNELLANTWORT: 20, SATZ_RENNEN: 15, WORTSCHATZ_DUELL: 20, WAS_BIN_ICH: 15, TEAM_BATTLE: 15 },
  B1: { SCHNELLANTWORT: 20, SATZ_RENNEN: 15, WORTSCHATZ_DUELL: 20, WAS_BIN_ICH: 15, TEAM_BATTLE: 15 },
  B2: { SCHNELLANTWORT: 20, SATZ_RENNEN: 15, WORTSCHATZ_DUELL: 20, WAS_BIN_ICH: 15, TEAM_BATTLE: 15 },
};
