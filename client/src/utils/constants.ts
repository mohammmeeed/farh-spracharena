...
export const QUESTION_COUNT_PRESETS = [3, 5, 10, 15];
export const MIN_QUESTION_COUNT = 1;
export const MAX_QUESTION_COUNT = 20;

export const AVAILABLE_QUESTIONS_MAP: Record<GameLevel, Record<GameType, number>> = {
  A1: { SCHNELLANTWORT: 60, SATZ_RENNEN: 25, WORTSCHATZ_DUELL: 35, WAS_BIN_ICH: 25, TEAM_BATTLE: 30 },
  A2: { SCHNELLANTWORT: 60, SATZ_RENNEN: 25, WORTSCHATZ_DUELL: 35, WAS_BIN_ICH: 25, TEAM_BATTLE: 30 },
  B1: { SCHNELLANTWORT: 60, SATZ_RENNEN: 25, WORTSCHATZ_DUELL: 35, WAS_BIN_ICH: 25, TEAM_BATTLE: 30 },
  B2: { SCHNELLANTWORT: 60, SATZ_RENNEN: 25, WORTSCHATZ_DUELL: 35, WAS_BIN_ICH: 25, TEAM_BATTLE: 30 },
};
